...
#define CONF_SERCOM_2_I2CM_BAUD 50000
#endif
...
#define CONF_SERCOM_2_I2CM_BAUD_BAUDLOW (((CONF_GCLK_SERCOM2_CORE_FREQUENCY - (CONF_SERCOM_2_I2CM_BAUD * 10U) - (CONF_SERCOM_2_I2CM_TRISE * (CONF_SERCOM_2_I2CM_BAUD / 100U) * (CONF_GCLK_SERCOM2_CORE_FREQUENCY / 10000U) / 1000U)) * 10U + 5U) / (CONF_SERCOM_2_I2CM_BAUD * 10U))
